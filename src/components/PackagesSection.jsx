...
const packageData = [
    {
        id: 'maldives',
        title: 'Maldives Paradise & Overwater Villa',
        ...
        popular: true,
        inclusions: ['5-Star Resort', 'Private Speedboat', 'Daily Breakfast', 'Seaplane Flight'],
        itinerary: [
            { day: 'Day 1', detail: 'Arriaval at Male Airport, private seaplane transfer to 5-star Overwater Resort.'},
            ...
            { day: 'Day 4', detail: 'Island hopping tour & private candielit beach dinner.'},
            { day: 'Day 5', detail: 'Breakfast, morning leaisure, and speedboat checkout transfer to airport.'}
        ]
    },
    {
        id: 'switzerland',
        title: 'Swiss Alps & Interlaken Luxury Escape',
        ...
        popular: true,
        inclusions: ['Roundtrip Flights', 'Alpine Train Pass', 'Luxury Chalet Hotel', 'Lake Thun Cruise'],
        itinerary: [
    ...
    {
        id: 'paris',
        title: 'Parisian Romance & Fashion Tour',
        ...
        popular: false,
        inclusions: ['Eiffel Tower VIP Access', 'Louvre Museum Pass', 'Seine Dinner Cruise', '4-Star Boutique Hotel'],
        itinerary: [
            { day: 'Day 1', detail: 'Arrival at Paris Charles de Gaulle Airport, private luxury transfer to hotel.'},
            { day: 'Day 2', detail: 'Skip-the-line Eiffel Tower & Louvre Meseum guided tour.'},
            { day: 'Day 3', detail: 'Day Trip to Palace of Versailles & gardens.'},
            { day: 'Day 4-5', detail: 'Champs-Elyses luxury shopping & evening Seine River dinner cruise.'},
            { day: 'Day 6', detail: 'Breakfast & departure transfer.'}
        ]
    },
    {
        id: 'bali',
        title: 'Bali Exotic Jungle & Beach Villa',
        ...
        popular: false,
        inclusions: ['Private Pool Villa', 'Floating Breakfast', 'Waterfalls Tour', 'Private Car Chauffeur'],
        itinerary: [
    ...
    },
    {
        ...
        popular: true,
        inclusions: ['Burk Khalifa At The Top', 'VIP Desert Safari', 'Yacht Cruise', '5-Star Hotel'],
        itinerary: [
            ...
            { day: 'Day 4', detail: 'Marian Yacht Cruise and airport departure.'}
        ]
    },
    {
        id: 'bosnia',
        title: 'Bosnia Nature & Lakes  Expedition',
        location: 'Srajevo & Mostar, Bosnia',
        ...
        popular: false,
        inclusions: ['Direct Flights', 'Private SUV Driver', 'Halal Dining Included', 'Kravice Waterfalls'],
        itinerary: [
...
export default function PackagesSection() {
    ...
    return (
        <section id="packages" className="py-24 bg-white relative font-sans overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 md:px-8">
                ...
                >
                    <div className="inline-flex items-center gap-2 bg-[#FF7A00]/10 text-[#FF7A00] px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wide">
                        <Compass size={16} />
                        <span>Curated Luxury Vacations</span>
                    </div>
                ...
                <div className="flex flex-wrap items-center justify-center gap-2.5 mb-14">
                    {[
                        { id: 'all', label: 'All Packages', flagImg: null },
                        { id: 'tropical', label: 'Tropical Islands', flagImg: 'https://flagcdn.com/w40/mv.png' },
                        { id: 'europe', label: 'European Escapes', flagImg: 'https://flagcdn.com/w40/ch.png' },
                        { id: 'arabian', label: 'Arabian Luxury', flagImg: 'https://flagcdn.com/w40/ae.png' },
                    ].map((tab) => (
                        <button
                            key={tab.id}
                        ...
                        >
                            {tab.flagImg && (
                                <img src={tab.flagImg} alt={tab.label} className="w-4 h-3 object-cover rounded-sm border border-slate-200" />
                            )}
                            <span>{tab.label}</span>
                        </button>
                    ))}
                    ...
                    >
                        {filteredPackages.map((pkg) => (
                            <motion.div
                                ...
                                className="bg-white rounded-3xl border border-slate-200/90 shadow-sm hover:shadow-2xl transition-all duration-300 flex flex-col justify-between overflow-hidden group text-left"
                            >
                                <div>
                                    {/* IMAGE HEADER WITH HOVER ZOOM & BADGES */}
                                    <div className="relative h-60 w-full overflow-hidden">
                                        ...
                                        {pkg.popular && (
                                            <div className="absolute top-4 left-4 bg-linear-to-r from-[#FF7A00] to-amber-500 text-white text-[10px] font-extrabold px-3 py-1 rounded-full uppercase tracking-wider shadow-md flex items-center gap-1">
                                                <Sparkles size={12} />
                                        ...
                                        {/* DURATIONG BADGE */}
                                        <div className="absolute bottom-4 left-4 bg-black/60 backdrop-blur-md text-white text-xs font-semibold px-3 py-1.5 rounded-xl border border-white/20 flex items-center gap-1.5">
                                            <Calendar size={14} className="text-amber-400" />
                                            <span>{pkg.duration}</span>
                                        </div>

                                        {/* RATING BADGE */}
                                        <div className="absolute bottom-4 right-4 bg-white/90 backdrop-blur-md text-slate-900 text-xs font-bold px-2.5 py-1 rounded-xl shadow-md flex items-center gap-1">
                    ...
                    {activeModalPackage && (
                        ...
                        >
                            <motion.div
                                ...
                                className="bg-white rounded-3xl max-w-xl w-full p-6 sm:p-8 space-y-6 shadow-2xl relative text-left max-h-[90vh] overflow-y-auto"
                            >
                                <button 
                                ...
                                <div className="flex items-center gap-3 border-b border-slate-100 pb-4">
                                    <img src={activeModalPackage.flagImg} alt={activeModalPackage.location} className="w-8 h-6 object-cover rounded shadow" />
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-slate-500">
                                            {activeModalPackage.duration} - Full Itinerary Schedule
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-4">
                                    <p className="font-bold text-xs uppercase tracking-wider text-slate-400">Day-by-Day Schedule</p>
                                ...
                                <div className="pt-4 border-t border-slate-100 flex items-center justify-between gap-4">
                                    ...
                                    <button
                                        onClick={() => {
                                            handleBook(activeModalPackage.title);
                                    ...
                                    >
                                        ...
                                        <span>Inquire Package via WhatsApp</span>
                                    </button>
                                </div>
